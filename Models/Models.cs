...
public class ProductWithMappingsDto
{
    public string Id { get; set; } = string.Empty;

    public string Code { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
    public string ProductType { get; set; } = string.Empty; // "term-life"
    public string? Description { get; set; }
    public int MinAge { get; set; } = 18;
    public int MaxAge { get; set; } = 65;
    public decimal MinSumAssured { get; set; } = 100000;
    public decimal MaxSumAssured { get; set; } = 10000000;
    public decimal MinPremium { get; set; } = 1000;
    public bool IsEnabled { get; set; } = true;

    public List<string> MappedRuleIds { get; set; } = new();
    public List<string> MappedGridIds { get; set; } = new();
    public List<string> MappedScorecardIds { get; set; } = new();

    public List<MedicalTriggerDto> MedicalTriggers { get; set; } = new();
}

public class MedicalTriggerDto
{
...
public class ProposalData
{
    ...
    public string? OccupationRisk { get; set; } // Occupation class: "class_1", "class_2", "class_3", "class_4"
    public string? AmlRisk { get; set; } // AML category: "low", "medium", "high"
    ...
    public string? SpecialClass { get; set; } // Special class (STP034): "HUF", "MWP", "employer_employee", "keyman"
    ...
    public bool IsLaProposerSame { get; set; } = true;
    ...
    public List<string>? AlcoholType { get; set; }
...
// ===== Rule Mapping & Medical trigger mapping dtos=====

public class ProductConfigurationDto
{
    public string Id { get; set; } = string.Empty;  // For updates
    ...
    public List<string> ScorecardIds { get; set; } = new();
...
public class ProductRuleMapping
{
    [Key]
    public string Id { get; set; } = Guid.NewGuid().ToString();
...
public class ProductMedicalTrigger
{
    [Key]
    public string Id { get; set; } = Guid.NewGuid().ToString();
    ...
    [Required]
    [MaxLength(50)]
    public string Field { get; set; } = string.Empty;  // age, sum_assured, bmi, smoker

    [Required]
    [MaxLength(20)]
    public string Operator { get; set; } = "eq";  // gt, lt, between, eq, ne

    [MaxLength(100)]
    public string Value { get; set; } = string.Empty;

    [MaxLength(100)]
    public string ValueMax { get; set; } = string.Empty;  // for between
    ...
    [Column(TypeName = "TEXT")]
    public string RequiredTests { get; set; } = "[]";  // ["ecg", "hiv", "lft"]
    public string CreatedAt { get; set; } = DateTime.UtcNow.ToString("o");
}
public class MaturityAgeRequest
{
